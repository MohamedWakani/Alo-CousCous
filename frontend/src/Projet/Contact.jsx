                        ...
                        <div className="container">
                            ...
                            <div className="row contact-form">
                                <div className="col-md-6 iframe">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3324.7841282769928!2d-7.605308485708466!3d33.55898465101112!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xda632adb55baec7%3A0xd371d5cf9d1ac005!2sOFPPT%20ISTA%20AG!5e0!3m2!1sfr!2sma!4v1677345417570!5m2!1sfr!2sma"></iframe>
                                </div>
                                <div className="col-md-6 cont-form">
                                    <div id="success"></div>
                                    <form Name="sentMessage" id="contactForm" novalidate="novalidate">
                                        <div className="control-group">
                                            <input type="text" classNameName="form-control" id="Name" placeholder="Your Name" required="required" data-validation-required-message="Please enter your Name" />
                                            <p classNameName="help-block text-danger"></p>
                                        </div><br />
                                        <div className="control-group">
